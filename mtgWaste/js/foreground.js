...
mw_outer.style = 'padding-left: 10px;'
...
var meterLoc = '.NyMmmf'; //default the meterLoc to '.NyMmmf' and then get it from local storage
...
elementReady(meterLoc, true).then((targetElement) => {
    targetElement.appendChild(mw_outer);
    startMeter();
});
